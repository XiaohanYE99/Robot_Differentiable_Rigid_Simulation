...
class ArticulatedLoader {
 public:
  ...
  static ArticulatedBody createBird(int root,bool head=false);
  static ArticulatedBody createBipedal(int root,bool withHand);
  static ArticulatedBody createChain(int root,T rad,int nrLink);
  static ArticulatedBody createSpider(int root,T lmt=45,T lmt2=60);
